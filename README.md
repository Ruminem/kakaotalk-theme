...
깃허브에서 만듦. 폰에서도 되지만 깃허브 로그인이 필요하고 3분쯤 걸림.

1. 이 저장소를 **Fork**
2. 포크한 저장소 **Actions** 탭 → **커스텀 테마 제작** → **Run workflow**
3. 칸을 채우고 실행. 테마 이름은 받기 링크에 있는 그대로 씀 (`camp-dark-image` 처럼)
4. 끝나면 그 실행의 **Artifacts** 에서 받음 — 아이폰용·안드로이드용·미리보기 그림이 같이 들어 있음
